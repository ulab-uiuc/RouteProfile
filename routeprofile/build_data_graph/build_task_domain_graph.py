...
DEFAULT_SAVE_PT          = os.path.join(_PD, "result_data_graph", "standard", "task_domain_graph_full.pt")
...
if __name__ == "__main__":
    ...
    _save_path        = _args.save        or os.path.join(_out_dir, "task_domain_graph_full.pt")

    main(_json_path, _arch_path, _dataset_path,
         _domain_map_path, _domain_feat_path, _save_path)