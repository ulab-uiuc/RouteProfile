...
DEFAULT_SAVE_PT          = os.path.join(_PD, "result_data_graph", "standard", "query_task_domain_graph_full.pt")
...
if __name__ == "__main__":
    ...
    _domain_map_path  = _args.domain_map  or os.path.join(_PD, "domain_task_map.json")
    _domain_feat_path = _args.domain_feat or os.path.join(_PD, "domain_feature.json")
    _query_path       = _args.query       or os.path.join(_PD, f"task_queries_{_args.mode}.json")
    _save_path        = _args.save        or os.path.join(_out_dir, "query_task_domain_graph_full.pt")

    main(_json_path, _arch_path, _dataset_path,
         _domain_map_path, _domain_feat_path, _query_path, _save_path)