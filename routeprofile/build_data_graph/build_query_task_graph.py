...
DEFAULT_SAVE_PT      = os.path.join(_PD, "result_data_graph", "standard", "query_task_graph_full.pt")
...
if __name__ == "__main__":
    ...
    _save_path    = _args.save    or os.path.join(_out_dir, "query_task_graph_full.pt")
